...
const NAV = [
  ...
  { href: "/procedures", label: "Procedures", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" },
  { href: "/insights", label: "Shared Insights", icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" },
...
export function Sidebar() {
  ...
  return (
    <aside className="flex w-56 flex-col border-r"
      style={{ background: "var(--color-sidebar)", borderColor: "transparent" }}>
      <div className="px-4 py-5">
        <h1 className="text-sm font-bold text-white">Support Admin</h1>
      </div>
